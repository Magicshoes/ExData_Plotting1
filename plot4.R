...
mdata$Global_reactive_power<- as.numeric(mdata$Global_reactive_power)
par(mfcol=c(2,2))
...
plot(mdata$newfilterDate,mdata$Global_reactive_power, type = "l", ylab ="Global_reactive_power", xlab = "")
